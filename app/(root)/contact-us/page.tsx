          ...
          <div>
            <div className="p-8 lg:border-r lg:border-slate-200 lg:sticky lg:top-16">
              ...
              <p className="text-slate-600 mb-6">
                If you are experiencing a medical emergency please call <strong className="text-slate-800">911</strong>{" "}
            ...
            <div className="p-8">
              <div className="mb-6">
                ...
                <p className="text-slate-600 mt-2">
                  We're here to help you with your healthcare needs. Whether you have questions, need to schedule an
                  appointment.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button
                  ...
                  className="h-12 px-8 bg-cyan-600 hover:bg-cyan-700 text-white rounded-md"
                >
