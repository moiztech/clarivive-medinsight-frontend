      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-20 space-y-4">
          <h2 className="text-4xl md:text-5xl font-bold text-medical-navy">
            {headingMain}
            <span className="text-secondary">{headingHighlight}</span> works
          </h2>
          ...
          <div className="w-full lg:w-1/2">
            <div className="relative">
              <div className="relative rounded-[40px] overflow-hidden border-2 border-blue-300">
                <Image src={imageSrc} alt={imageAlt} width={imageWidth} height={imageHeight} className="w-full h-auto object-cover aspect-[4/3]" />
                <div className="absolute bottom-10 left-10 right-10 bg-white rounded-2xl p-5 shadow-xl flex items-center gap-4 animate-bounce-slow">
                  <div className="w-10 h-10 rounded-full bg-secondary/10 flex items-center justify-center">
                    <BadgeIcon className="w-5 h-5 text-secondary fill-secondary" />
                  </div>
                  <span className="text-medical-navy font-bold text-lg">{badgeText}</span>
                </div>
              </div>
