...
export default function BusinessOutcomesSection() {
  ...
  const tabContent = {
    ...
    employee: {
      ...
      description: "Empower your employees to develop their skills, advance their careers, and drive your business forward. Join over 4,000 top-performing companies who trust Litmos to engage and retain their talent.",
      benefits: ["Improve skills", "Support career growth", "Improve business performance", "Enhance employee satisfaction"],
    ...
    onboarding: {
      ...
      description: "Simplify onboarding for employees, partners, and customers with our all-in-one learning solution. Streamline your tech stack with an intuitive platform that accelerates time-to-value for everyone.",
      benefits: ["Enhance new employee experience", "Reduce ramp for revenue teams", "Improve time to value for customers", "Increase efficiency with one solution"],
    ...
    revenue: {
      ...
      description: "Unleash the full potential of your revenue teams – sales, marketing, and customer experience. Drive performance, engagement, and bottom-line growth with Litmos' comprehensive learning solution, trusted by thousands of top-performing companies.",
      benefits: ["Improve skills, support re-skilling", "Engage revenue teams", "Improve business performance", "Support career growth"],
    ...
    customer: {
      ...
      description: "Increase customer loyalty and retention with impactful training that strengthens their connection to your brand. Litmos' flexible, scalable platform delivers engaging customer training experiences that drive results.",
      benefits: ["Engage customers with your brand", "Provide 24/7 access to product knowledge", "Improve customer satisfaction", "Monetize product content"],
    ...
    member: {
      ...
      description: "Engage your members with high-quality training content that keeps them coming back. Build a thriving learning community with Litmos' intuitive platform designed for membership organizations.",
      benefits: ["Increase member engagement", "Deliver consistent training", "Track member progress", "Build learning communities"],
            ...
            <div key={category.id}>
              <button
                ...
                className={`
                  ...
                  `}
              >
                <div className={`${category.color} flex justify-center mb-3 w-14 h-14 items-center mx-auto transition-transform duration-300 py-2 ${activeTab === category.id ? "scale-120" : ""}`}>{category.icon}</div>
