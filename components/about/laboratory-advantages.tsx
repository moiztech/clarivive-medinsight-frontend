  ...
  advantages = [
    {
      ...
      description:
        "Structured, practical training designed to support safe practice in health and social care settings.",
    },
    {
      icon: CircleCheckBig,
      title: "Quality, Governance & Standards Alignment",
      description:
        "Training developed in line with relevant UK guidance and sector frameworks, supporting consistency, safety, and regulatory confidence.",
    },
    {
      icon: Handshake,
      title: "Partnership-Led Training Support",
      description:
        "Working with health and social care organizations to deliver training that fits local policies, roles, and operational needs.",
    },
    {
      icon: GraduationCap,
      title: "Experienced Healthcare Trainers",
      description:
        "Training delivered by practitioners with relevant sector experience and subject knowledge appropriate to the courses provided.",
    },
  ],
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="flex-1">
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
              {heading}{" "}
              <span className="text-primary-blue italic font-serif">
                {highlightedText}
              </span>{" "}
              {headingPost}
            </h2>
